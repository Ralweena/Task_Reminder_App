...
public class partyReminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_reminder);
        ...
        createReminder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                category.putString("category","Party");
        ...
        Cursor cursor = new dbManager(getApplicationContext()).readPartyReminders();
