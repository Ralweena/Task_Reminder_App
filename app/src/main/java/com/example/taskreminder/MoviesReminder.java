...
public class MoviesReminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movies_reminder);
        ...
        createReminder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                category.putString("category","Movies");
        ...
        Cursor cursor = new dbManager(getApplicationContext()).readMoviesReminders();
